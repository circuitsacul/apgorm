...
ALTER TABLE _migrations ADD CONSTRAINT __migrations_id__primary_key PRIMARY KEY ( _migrations.id_ );
ALTER TABLE games ADD CONSTRAINT _games_id__primary_key PRIMARY KEY ( games.id_ );
ALTER TABLE players ADD CONSTRAINT _players_username_gameid_primary_key PRIMARY KEY ( players.username , players.gameid );
ALTER TABLE users ADD CONSTRAINT _users_name_primary_key PRIMARY KEY ( users.name );
